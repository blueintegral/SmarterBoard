...
% Read in standard MATLAB demo image
 fprintf('Getting a new image!\n');
   ...
   system('C:/Users/hunter/Desktop/mhacks/capture.py');
   ...
   capture_crop = imcrop(capture_raw, [160, 46  , 350, 300]);
   %hold on;
   %figure
   capture_crop_gray = rgb2gray(capture_crop);


%originalImage = imread('capture_raw.jpg'); 
originalImage = capture_crop_gray;
